...
class Annotation {
    ...
    init(tool: AnnotationTool, startPoint: CGPoint, color: NSColor = .systemRed, lineWidth: CGFloat = 2) {
        self.tool = tool
    ...
    var boundingRect: CGRect {
        ...
        case .text:
            ...
            return CGRect(origin: startPoint, size: CGSize(width: max(size.width, 50), height: max(size.height, 20)))
        default:
            let rect = CGRect(
